...
const email = userEmail
  ...
  const handleSubmit = async () => {
    ...
    if (itemName !== "" && file !="") {
      ...
      Alert.alert('Donation unsuccessfull enter an amount/item you want to donate');
    }
  };
  ...
  const goToUserInfoPage = () => {
    navigation.navigate('Payment',{donor:donor,email:email,contact:contact,customAmount:customAmount,selectedFrequency:selectedFrequency,selectedCampaign:selectedCampaign,NpoName:NpoName});
  };
